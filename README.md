...
## Use cases
  ...
  1. **You are developing your code and don't want to go over the WiFi setup everytime, but also don't want to spoil your config** - In your `setup()` method, after calling `iotWebConf.init()` you can call `iotWebConf.updateWiFiAuthInfo("<YOUR_DEV_WIFI_SSID>", "<YOUR_DEV_WIFI_PWD>");`
