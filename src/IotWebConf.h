...
public:
   ...
   */
  ApConnectionState getConnectionState() { return this->_apConnectionState; };
   ...
   *
   */
  unsigned long getApLastConnectionTimeMs()
  {
    return this->_apLastConnectedTimeMs;
  }
...
private:
  ...
  unsigned long _apLastConnectedTimeMs = 0;
