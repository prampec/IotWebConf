...
IotWebConfParameter::IotWebConfParameter(
    ...
    const char* customHtml, bool visible)
{
  this->label = label;
  this->_id = id;
...
bool IotWebConf::init()
{
  ...
  this->configInit();
  bool validConfig = this->configLoad();
  if (!validConfig)
  {
    // -- No config
...
bool IotWebConf::configTestVersion()
{
 ...
 */
bool IotWebConf::handleCaptivePortal()
{
